...
namespace SocialGames
{
    public class DialogBox : Game1
    {
        ...
        public DialogBox()
        {
            ...
            var posX = Const.CenterScreen.X - (Size.X / 2f);
        ...
        public void Update()
        {
            if (Active)
            {
                ...
                if (Program.Game.KeyState.IsKeyDown(Keys.Enter) && Program.Game.PreviousKeyState.IsKeyUp(Keys.Enter)) // || o click del mouse? //)
                {
                ...
                if (Program.Game.KeyState.IsKeyDown(Keys.X) && Program.Game.PreviousKeyState.IsKeyUp(Keys.X)) // || o click del mouse? //)
                {
                    Hide();
                }
            }
