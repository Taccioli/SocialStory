...
namespace SocialGames_Android
{
    public class Const : Game1
    {
        ...
        public static Vector2 DisplayDim = new Vector2(1080, 1920);
        ...
        public static Vector2 CenterScreen = new Vector2(960,540);

        public static Vector2 Proportions = new Vector2(GraphicsAdapter.DefaultAdapter.CurrentDisplayMode.Width / 1920f,
